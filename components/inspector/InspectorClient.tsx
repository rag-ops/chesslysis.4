...
type Review = {
  ...
  moves: { ply:number; moveNumber:number; color:"w"|"b"; san:string; uci:string; fenBefore:string; fenAfter:string }[];
  analyses: Record<number, { evaluationAfter:number|null; mate:number|null; bestMove:string|null; bestMoveSan:string|null; principalVariation:string[]; evaluationLoss:number; classification:string }>;
};
